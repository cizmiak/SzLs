USE SpravaZmluv
go
if object_id('dbo.AddTableColumn') is null
exec ('create procedure dbo.AddTableColumn as')
go
alter procedure dbo.AddTableColumn
	@table nvarchar(128),
	@column nvarchar(128),
	@type nvarchar(128)
as
...
exec dbo.AddTableColumn 'dbo.SkoleniePosluchac', 'PreukazVydany', 'datetime'
exec dbo.AddTableColumn 'dbo.SkoleniePosluchac', 'PreukazVydal', 'varchar(100)'
go
...
insert into dbo.Konfiguracia(Nastavenie, Hodnota)
SELECT 'Report','Zaznamy/ViazaciBremien'
where
	not exists (select * from dbo.Konfiguracia where Nastavenie = 'Report' and Hodnota = 'Zaznamy/ViazaciBremien')
go